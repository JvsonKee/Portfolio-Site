            ...
            <YSlide>
                <SectionWrapper>
                    ...
                    <SectionContentContainer>
                        ...
                        <div>Currently working as a full-stack developer at <a href="https://enlighten-media.com" target="_blank" style={{fontStyle: "italic"}}>Enlighten Media</a>. Here, I am leveraging my front-end and back-end skills to create innovative solutions that enhance user experience and drive business growth. </div>
